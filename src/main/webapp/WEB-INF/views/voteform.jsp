...
<body class="text-center" data-new-gr-c-s-check-loaded="14.1042.0"
	...
	<main class="form-signin">
		<form:form commandName="boardVO" method="POST" action="../voteok">
			...
			<h1 class="h3 mb-3 fw-normal">투표해 주세요.</h1>
			
			
			<table id="edit">
				<tr class="form-floating">
					<td>Voting(!One vote per person!):</td>
					<td><form:input path="vote" type="number" class="form-control" /></td>
				</tr>
				
			</table>
			<div style='margin-top: 20px' class="d-grid gap-2">
				<button class="w-100 btn btn-lg btn-primary" type="submit" value="Vote" onclick='vote_click()'>Vote</button>
